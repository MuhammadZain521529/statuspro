...
import com.muhammadzain.statuspro.databinding.ActivityVideoBinding;
    ...
    private void handleClicks() {
        ...
        mBinding.icDeleteVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new FancyAlertDialog.Builder(VideoActivity.this)
                        ...
                        .OnPositiveClicked(new FancyAlertDialogListener() {
                            ...
                            public void OnClick() {
                                ...
                                try {
                                    if (file.exists()) {
                                        file.delete();
                                        Toast.makeText(VideoActivity.this, "Deleted Successfully", Toast.LENGTH_SHORT).show();
                                        Intent intent=new Intent(VideoActivity.this,Whatsapp.class);
                                        intent.putExtra("isDeleteWpVideo",true);
        ...
        mBinding.icShareVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(VideoActivity.this, "Please Wait....", Toast.LENGTH_LONG).show();
                isVisible=!isVisible;
                toogleFabs(isVisible);
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (uri_new.toString().endsWith(".mp4")){
                            ...
                            Uri uri= FileProvider.getUriForFile(VideoActivity.this,getApplicationContext().getPackageName()+".provider",fileur);
                            if (uri !=null){
                                ...
                                Toast.makeText(VideoActivity.this, "Unable to display image.....", Toast.LENGTH_SHORT).show();
                            }
                        }
        ...
        mBinding.icRepostVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(VideoActivity.this, "Please Wait....", Toast.LENGTH_SHORT).show();
                isVisible=!isVisible;
                toogleFabs(isVisible);
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        if(isValid(file)){
                            ...
                            try {
                                ...
                                Toast.makeText(VideoActivity.this, "No application found to open this file.", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                }).start();
...
//
    ...
    private void downloadImage(VideoModel list) throws IOException {
        ...
        Snackbar.make(mBinding.videoViewCurrent,"Video Saved Successfully", Snackbar.LENGTH_LONG)
                .setAction("Open Saved Gallery", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(VideoActivity.this, SavedGallery.class);
    ...
    private void getIntents() {
        ...
        if (intent!=null){
            VideoModel selectedVideo = (VideoModel) intent.getSerializableExtra("selected_video");
    ...
    private void setupUpPlayer(String path) {
        ...
        mExoPlayer= ExoPlayerFactory.newSimpleInstance(VideoActivity.this,trackSelector);
        ...
        mPlayPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(previous >= 0){
                    VideoModel previousVideo = list.get(previous);
    ...
    private void playVideo(VideoModel video, int videoPosition) {
        if(video != null){
